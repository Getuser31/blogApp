...
'filesystems.links./var/www/html/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths',
...
'articles.index','articles.store','articles.show','articles.update','articles.destroy','home','dashboard','profile.edit',
'profile.update','profile.destroy','password.edit','password.update','appearance',
'register','register.store','login','login.store','password.request',
'password.email','password.reset','password.store','verification.notice','verification.verify',
'verification.send','password.confirm','password.confirm.store','logout','storage.local',);
